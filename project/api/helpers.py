...
def prepare_member_dict(member):
    ...
    member_dict = {
        ...
        'plan': member.plan,
        'client_policy_number': member.client_policy_number,
        'client_id_number': member.client_id_number,
...
def convert_dict_member_model(member_dict):
    ...
    member = models.Member(
                ...
                telephone=member_dict['telephone'],
                dob=dob,
                sex=member_dict['sex'],
                ...
                client_policy_number=member_dict['client_policy_number'],
                client_id_number=member_dict['client_id_number'],
